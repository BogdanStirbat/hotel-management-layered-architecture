...
INSERT INTO user(id, email, password, role)
VALUES (2, 'staff@test.com', '$2a$10$tkhB/TaixEmRD.gzZFcFvOxkQhnGfddLXddbdltwS.EzJZnCwboJm', 'STAFF');

-- Create the client user (password: client)
INSERT INTO user(id, email, password, role)
VALUES (3, 'client@test.com', '$2a$10$Wsv67kzmHUaszaST56Se3OEMMjf1q1WNEiv1qluuqPBOO45PYmPA2', 'CLIENT');